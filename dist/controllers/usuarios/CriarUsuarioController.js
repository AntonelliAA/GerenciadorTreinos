...
const CriarUsuarioService_1 = require("../../services/usuarios/CriarUsuarioService");
class CriarUsuarioController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const usuario = yield criarUsuarioService.execute({ nome, email, idade, altura, peso, senha });
